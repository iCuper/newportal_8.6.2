...
class Post(models.Model):
    ...
    types_post = models.CharField(max_length=2, choices=Types, default='NE',
...
class Comment(models.Model):
    ...
    user_comment = models.ForeignKey(User, on_delete=models.CASCADE,
                                     verbose_name='Автор комментария')  # связь «один ко многим» со встроенной моделью User ;
    ...
    datetime_comment = models.DateTimeField(auto_now_add=True,
                                            verbose_name='Дата и время комментария')  # дата и время создания комментария;
